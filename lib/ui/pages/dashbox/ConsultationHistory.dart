  ...
  Widget build(BuildContext context) {
    return Scaffold (
      appBar: AppBar(
        ...
        title: Text('Consultation History', style: TextStyle(fontFamily:'Segoe', color: kTitleColor, letterSpacing: 0.5),),
      ),
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    image: DecorationImage(
                      image: ExactAssetImage('assets/consulthistorypage.png'),
